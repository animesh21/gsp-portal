...
<div class="content-form">
  ...
  <div class="form-group" id="Q3G2">
    ...
    <div class="form-group row">
      <?php if(empty($data["Q3G2"])) $data['Q3G2']=0; echo form_dropdown('Q3G2', $states,set_value('Q3G2',$data["Q3G2"]), array('class' => 'form-control', 'id' => 'country-select')); ?>
    </div>
  </div>
  ...
  <button type="submit" id="movenextbtn" value="movenext" name="movenext" accesskey="n" class="submit button" onClick="javascript:window.location.href='<?php echo base_url("school")?>';">Previous</button>

      <button type="submit" id="movenextbtn" value="movenext" name="movenext" accesskey="n" class="submit button" onClick="javascript:window.location.href='<?php echo base_url("air")?>';">Next</button>
