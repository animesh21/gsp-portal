  ...
  <div class="content-form">
    ...
    <div class="form-group">
      ...
      <div class="question-text">
        ...
        <p> To find total consumption, monitor water consumption over a period of three working days, spread over one month and take the average.</p>
    ...
    <div class="text-center">
      ...
      <button type="button" id="movenextbtn" value="movenext" name="movenext" accesskey="n" class="submit button" onClick="javascript:window.location.href='<?php echo base_url("waste")?>';">Next</button>
...
<div id="videoModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="background:transparent; border-radius:0px;">
      ...
      <iframe width="100%" height="330px" src="https://www.youtube.com/embed/todM6wToHHQ" id="video" frameborder="0" allowfullscreen></iframe>
    </div>
  </div>
</div>
<script type="text/javascript">
 $('.close').click(function(){
    $('#video').attr("src","https://www.youtube.com/embed/todM6wToHHQ");
 });
</script>